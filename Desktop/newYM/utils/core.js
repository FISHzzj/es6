...
module.exports = {
  ...
  json: function(t, n, o, i, a, c) {
    var r = getApp(),
      ...
      // console.log(s);
    n = n || {}, n.comefrom = "wxapp", s && (n.openid =  s.openid, "cacheset" != t && r.getSet());
  ...
  onShareAppMessage: function(t) {
    var e = getApp(),
      ...
      c = n.shopname || "",
      r = n.description || "";
    return o.title && (c = o.title), o.desc && (r = o.desc), i && (a = i.id), t = t || "/pages/homePage/homePage", t = -1 != t.indexOf("?") ? t + "&" : t + "?", {
      title: c,
      desc: r,
      path: t + "mid=" + a
    }
